...
class AIDifficultyIIWindow(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.easy_image = self.person_image.resize((175, 175))
        ...
        self.hard_image = self.matchmake_image.resize((175, 175))
        self.hard_image = ImageTk.PhotoImage(self.matchmake_image)
